...
public class SeasonVerticle  extends AbstractGuiceVerticle {
	...
	/** The Constant GET. */
	public static final String GET = "resthandler.api.v1.commons.settings.season.get";
	
	/** The Constant GET_LIST_BY_ACTIVITY. */
	public static final String GET_LIST_BY_ACTIVITY = "resthandler.api.v1.commons.settings.season.getListByActivity";
