...
public final class PasswordEncryptionServiceImpl implements PasswordEncryptionService {
	 ...
	 */
	@Override public boolean authenticate(final String attemptedPassword, final byte[] encryptedPassword, final byte[] salt) throws InvalidKeySpecException, NoSuchAlgorithmException {
	 ...
	 * @throws InvalidKeySpecException  the invalid key spec exception
	 */
	@Override public byte[] getEncryptedPassword(final String password, final byte[] salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
	 ...
	 * @throws NoSuchAlgorithmException the no such algorithm exception
	 */
	@Override public byte[] generateSalt() throws NoSuchAlgorithmException {
