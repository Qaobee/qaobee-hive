...
public final class MailUtilsImpl implements MailUtils {
	 ...
	 */
	@Override public JsonObject generateActivationBody(final User user, final String locale) {
	 ...
	 * @return the json object
	 */
	@Override public JsonObject generateNewpasswdBody(final User user, final String locale) {
		final JsonObject json = new JsonObject();
	 ...
	 */
	@Override public JsonObject generatePaymentBody(final User user, final String locale, final Plan planItem) {
		final JsonObject json = new JsonObject();
	 ...
	 * @return body json object
	 */
	@Override public JsonObject generateRefoundBody(User user, String locale, Plan planItem) {
		final JsonObject json = new JsonObject();
