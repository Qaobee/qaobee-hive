...
public class ChampionshipTest extends VertxJunitSupport {
	...
	@Test public void getListChampionShipsTest() {
	...
	@Test public void getListChampionShipsWithInfraTest() {
		// Populate default value
		populate(POPULATE_ONLY, DATA_CHAMPIONSHIP_HAND);
		// User connected
		User user = generateLoggedAdminUser();
	...
	@Test public void getListChampionShipsWithInfraUnknownTest() {
		// Populate default value
		populate(POPULATE_ONLY, DATA_CHAMPIONSHIP_HAND);
		// User connected
		User user = generateLoggedAdminUser();
	...
	@Test public void getChampionShipTest() {
		populate(POPULATE_ONLY, DATA_CHAMPIONSHIP_HAND);
		User user = generateLoggedAdminUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	...
	@Test public void addChampionShipTest() {
		User user = generateLoggedAdminUser();
	...
	@Test public void updateChampionShipTest() {
		populate(POPULATE_ONLY, DATA_CHAMPIONSHIP_HAND);
		User user = generateLoggedAdminUser();
		RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
