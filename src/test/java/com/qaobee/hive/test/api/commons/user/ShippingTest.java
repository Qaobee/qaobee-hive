...
public class ShippingTest extends VertxJunitSupport {
	...
	@Before public void initMockServer() {
		mockServer = startClientAndServer(1080);
	}

	@After public void stopMockServer() {
		mockServer.stop();
	}
	 ...
	 * Create payment test.
	 */
	@Test public void createPaymentTest() {
	 ...
	 */
	@Test public void createPaymentWithWrongPlanIdTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void createPaymentWithMissingPlanIdTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void createPaymentWithWrongHttpMethodTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void recievePayplugNotificationTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWithWrongHttpMethodTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWithMissingMandatoryDataTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWithMissingMetadataTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWrongMetadataTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWrongObjectTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWrongPlanIdTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationNotPaidTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void recievePayplugNotificationWrongUserIdTest() {
		User u = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
