...
public class UserTest extends VertxJunitSupport {
	 ...
	 */
	@Test public void badloginHTTPMethod() {
		User u = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void loginOkWithMobileToken() {
		User u = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void loginPasswordKo() {
		User u = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void loginUserInactive() {
		try {
			User u = generateUser();
	 ...
	 */
	@Test public void getMetasWithWrongHTTPMethod() {
		populate(POPULATE_ONLY, SETTINGS_ACTIVITY, DATA_SANDBOXES_HAND, SETTINGS_SEASONS);
		User user = generateLoggedUser("5509ef1fdb8f8b6e2f51f4ce");
		user.getAccount().getListPlan().get(0).getActivity().set_id("ACT-HAND");
		try {
	 ...
	 */
	@Test public void getMetasWithWrongUser() {
		populate(POPULATE_ONLY, SETTINGS_ACTIVITY, DATA_SANDBOXES_HAND, SETTINGS_SEASONS);
	 ...
	 */
	@Test public void loginByMobileToken() {
		User u = generateUser();
	 ...
	 */
	@Test public void loginByMobileTokenWrongHTTPMethod() {
		User u = generateUser();
		String token = UUID.randomUUID().toString();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void loginByMobileTokenWrongLogin() {
		User u = generateUser();
		String token = UUID.randomUUID().toString();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void loginByMobileTokenWrongToken() {
		User u = generateUser();
		String token = UUID.randomUUID().toString();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void loginByMobileTokenNoData() {
		User u = generateUser();
		String token = UUID.randomUUID().toString();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void getMetasNotLogged() {
	 ...
	 */
	@Test public void getMetasWrongHTTPMethod() {
		populate(POPULATE_ONLY, SETTINGS_ACTIVITY, DATA_SANDBOXES_HAND);
		User user = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void getUserByIdNotLogged() {
		User user = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.GET);
	 ...
	 */
	@Test public void getUserByIdWrongHTTPMethod() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void getCurrentUser() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.GET);
	 ...
	 */
	@Test public void getCurrentUserNotLogged() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.GET);
	 ...
	 */
	@Test public void getCurrentUserWrongHTTPMethod() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void logoutBadHTTPMethod() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 * Password renew.
	 */
	@Test public void passwordRenew() {
		User user = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void passwordRenewBadRequest() {
		User user = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void passwordRenewBadLogin() {
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
		JsonObject query = new JsonObject();
	 ...
	 */
	@Test public void passwordRenewBadHTTPMethod() {
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.GET);
		JsonObject reply = new JsonObject(sendonBus(UserVerticle.PASSWD_RENEW, req));
	 ...
	 */
	@Test public void passwordRenewActivationCodeCheck() {
		try {
	 ...
	 */
	@Test public void passwordRenewWrongActivationCodeCheck() {
		// First step ask for a new code
		User user = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void passwordRenewActivationCodeCheckBadHTTPMethod() {
		// First step ask for a new code
		User user = generateUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
	 ...
	 */
	@Test public void passwordResetWrongCode() {
		try {
			// First step ask for a new code
			User user = generateUser();
			final RequestWrapper req = new RequestWrapper();
	 ...
	 */
	@Test public void passwordResetWrongHTTPMethod() {
		try {
			// First step ask for a new code
			User user = generateUser();
			final RequestWrapper req = new RequestWrapper();
