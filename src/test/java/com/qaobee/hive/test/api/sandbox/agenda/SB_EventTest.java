...
public class SB_EventTest extends VertxJunitSupport {
	 ...
	 */
	@Test public void addEventWithMissingMandatoryParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void addEventWithWrongHttpMethodTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void addEventWithNotLoggedUserTest() {
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void getListEventTest() {
	 ...
	 */
	@Test public void getListEventWithWrongHttpMethodTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getListEventWithMissingParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getListEventWithNotLoggedUserTest() {
		//First Add an event
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void getEventByIdTest() {
	 ...
	 */
	@Test public void getEventByIdWithWrongHttpMethodTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getEventByIdWithNotLoggedUserTest() {
		//First Add an event
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.GET);
	 ...
	 */
	@Test public void getEventByIdWithMissingParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getEventByIdWithEmptyParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
