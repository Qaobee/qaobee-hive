...
public class SB_CollecteTest extends VertxJunitSupport {
	 ...
	 * Add event test.
	 */
	@Test public void addCollecteTest() {
	 ...
	 */
	@Test public void addCollecteWithMissingMandatoryParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void addCollecteWithWrongHttpMethodTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void addCollecteWithNotLoggedUserTest() {
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void getListCollecteTest() {
	 ...
	 */
	@Test public void getListCollecteWithWrongHttpMethodTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getListCollecteWithMissingParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getListCollecteWithNotLoggedUserTest() {
		//First Add an event
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.POST);
	 ...
	 */
	@Test public void getCollecteByIdTest() {
	 ...
	 */
	@Test public void getCollecteByIdWithWrongHttpMethodTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getCollecteByIdWithNotLoggedUserTest() {
		//First Add an event
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setMethod(Constantes.GET);
	 ...
	 */
	@Test public void getCollecteByIdWithMissingParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
	 ...
	 */
	@Test public void getCollecteByIdWithEmptyParametersTest() {
		User user = generateLoggedUser();
		final RequestWrapper req = new RequestWrapper();
		req.setLocale(LOCALE);
		req.setUser(user);
