...
@RunWith(VertxJUnit4ClassRunner.class) @VertxConfiguration(modsDir = "build/mods", injectResources = true) @TestModule(name = "com.qaobee~hive~0.1", jsonConfig = "file:config.json") @Ignore public class VertxJunitSupport
	 ...
	 * The Mongo.
	 */
	@Inject protected MongoDB mongo;

	/**
	 * Start mongo server.
	 */
	@BeforeClass public static void startMongoServer() {
	...
	@AfterClass public static void stopAll() {
